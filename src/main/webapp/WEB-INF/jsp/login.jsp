...
<div class="jumbotron py-0">
    <div class="container">
        ...
        <br/>
        <p>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('1@tut.by', 'Password1')">
                <spring:message code="app.login"/> User
            </button>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('admin@tut.by', 'Password')">
